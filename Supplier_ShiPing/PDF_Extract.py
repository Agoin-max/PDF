    ...
    def get_info(self, start, end, dict_words, x0, top, bottom, x1, dict_values, r, config_info, company_number, index,
        ...
        for i in range(start, end):
            ...
            if x0 - Decimal(x0_left) <= dict_words[i]["x0"] <= x0 + Decimal(x0_left) and \
                ...
                # if dict_words[i + 9]["text"].find("COO") >= 0 and dict_words[i + 10]["text"].find(",") >= 0:
                #     dict_values.setdefault("COO", []).append(
                #         dict_words[i + 9]["text"].split(":")[1] + " " + dict_words[i + 10]["text"].replace(",", ""))
                # elif dict_words[i + 9]["text"].find("COO") >= 0:
                #     dict_values.setdefault("COO", []).append(
                #         dict_words[i + 9]["text"].split(":")[1].replace(",", ""))
                #
                # if dict_words[i + 9]["text"].find("COO") >= 0 and dict_words[i + 10]["text"].find(",") >= 0:
                #     dict_values.setdefault("COO", []).append(
                #         dict_words[i + 9]["text"].split(":")[1] + " " + dict_words[i + 10]["text"].replace(",", ""))
                ...
                #         dict_words[i + 9]["text"].split(":")[1].replace(",", ""))
                #
                # if dict_words[i + 9]["text"].find("Made") >= 0 and dict_words[i + 12]["text"].find(",") >= 0:
                #     dict_values.setdefault("COO", []).append(
                #         dict_words[i + 11]["text"] + " " + dict_words[i + 12]["text"].replace(",", ""))
                # elif dict_words[i + 9]["text"].find("Made") >= 0:
                #     dict_values.setdefault("COO", []).append(dict_words[i + 11]["text"].replace(",", ""))
        ...
        for c in range(start, end):
            ...
            for t in range(1, 100):
                if x0 - Decimal(x0_left) <= dict_words[c]["x0"] <= x0 + Decimal(x0_left) and top + Decimal(
                    ...
                    # if dict_words[c + 9]["text"].find("COO") >= 0 and \
                    #         dict_words[c + 10]["text"].find(",") >= 0:
                    #     dict_values.setdefault("COO", []).append(
                    #         dict_words[c + 9]["text"].split(":")[1] + " " +
                    #         dict_words[c + 10]["text"].replace(",", ""))
                    # elif dict_words[c + 9]["text"].find("COO") >= 0:
                    #     dict_values.setdefault("COO", []).append(
                    #         dict_words[c + 9]["text"].split(":")[1].replace(",", ""))
                    # if dict_words[c + 9]["text"].find("Made") >= 0 and \
                    #         dict_words[c + 12]["text"].find(",") >= 0:
                    #     dict_values.setdefault("COO", []).append(
                    #         dict_words[c + 11]["text"] + " " +
                    #         dict_words[c + 12][
                    #             "text"].replace(",", ""))
                    # elif dict_words[c + 9]["text"].find("Made") >= 0:
                    #     dict_values.setdefault("COO", []).append(
                    #         dict_words[c + 11]["text"].replace(",", ""))
