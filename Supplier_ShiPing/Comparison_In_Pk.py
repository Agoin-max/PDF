...
class ExcelComparison:
    ...
    def invoke_pandas(self, path):
        ...
        for index, row in df.iterrows():
            ...
            append_dict["P/O"] = row["P/O"]
            append_dict["QUANTITY"] = row["QUANTITY"]
            append_dict["COO"] = row["COO"]
            ...
            for r in self.__excel_list:
                ...
                if self.__set_list == []:
                    ...
                    for c in self.__set_list:
                        if r["Invo"] == c["Invo"] and r["Item"] == c["Item"] and  r["P/O"] == c["P/O"]:
                            isExists = True
...
# ExcelComparison().invoke_pandas(r"C:\Users\windo\PycharmProjects\PDF\ExcelFile\INVOICE.xlsx")
